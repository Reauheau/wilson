...
func NewResearchAgent(llmManager *llm.Manager, contextMgr *contextpkg.Manager) *ResearchAgent {
	base := NewBaseAgent("Research", llm.PurposeAnalysis, llmManager, contextMgr)
...
func (a *ResearchAgent) CanHandle(task *Task) bool {
...
func (a *ResearchAgent) buildUserPrompt(task *Task, currentCtx *contextpkg.Context) string {
