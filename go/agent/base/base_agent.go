...
func (a *BaseAgent) SendFeedback(ctx context.Context, feedbackType agent.FeedbackType,
	severity agent.FeedbackSeverity, message string,
	context map[string]interface{}, suggestion string) error {

	bus := feedback.GetFeedbackBus()

	feedbackMsg := &agent.AgentFeedback{
...
func (a *BaseAgent) SendFeedbackAndWait(ctx context.Context, feedbackType agent.FeedbackType,
	severity agent.FeedbackSeverity, message string,
	context map[string]interface{}, suggestion string) error {
	...
	return bus.SendAndWait(ctx, feedbackMsg)
}
...
// taskType should be one of: "code", "test", "review", "research", "analysis"
func (a *BaseAgent) RequestDependency(ctx context.Context, description string,
	taskType string, reason string) error {
	...
	errorInfo["dependency_type"] = taskType
