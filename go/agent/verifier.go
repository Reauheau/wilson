...
type TaskVerifier interface {
	Verify(ctx context.Context, execResult *ExecutionResult, task *Task) error
}
...
func (v *CodeTaskVerifier) Verify(ctx context.Context, execResult *ExecutionResult, task *Task) error {
...
func (v *CodeTaskVerifier) isGoTask(task *Task, execResult *ExecutionResult) bool {
...
func (v *TestTaskVerifier) Verify(ctx context.Context, execResult *ExecutionResult, task *Task) error {
	// Check 1: At least one tool was executed
	if len(execResult.ToolsExecuted) == 0 {
		return fmt.Errorf("verification failed: no tools were executed")
	}
...
func (v *ReviewTaskVerifier) Verify(ctx context.Context, execResult *ExecutionResult, task *Task) error {
